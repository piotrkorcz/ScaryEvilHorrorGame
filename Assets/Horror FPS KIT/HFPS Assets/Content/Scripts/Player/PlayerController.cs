...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
		...
		if (controllable) {
			if (ControlFreak2.CF2Input.GetKey ("W")) {
				GetKeyAxis ("Y", "fw", 1);
			...
			if (ControlFreak2.CF2Input.GetKey ("S")) {
				GetKeyAxis ("Y", "bw", -1);
               // navMeshAgent.enabled = false;
			} else {
				GetKeyAxis ("Y", "bw", 0);
			...
			if (ControlFreak2.CF2Input.GetKey ("A")) {
				GetKeyAxis ("X", "l", -1);
			...
			if (ControlFreak2.CF2Input.GetKey ("D")) {
				GetKeyAxis ("X", "r", 1);
		...
		if (ControlFreak2.CF2Input.GetKeyDown("Left Control"))
        {
            CheckDistance();
